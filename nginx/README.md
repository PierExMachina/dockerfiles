...
## Tag available
* latest, mainline, 1.11.13, 1.11 [(Dockerfile)](https://github.com/xataz/dockerfiles/blob/master/mginx/mainline/Dockerfile)
* latest, stable, 1.12.0, 1.12 [(Dockerfile)](https://github.com/xataz/dockerfiles/blob/master/mginx/stable/Dockerfile)
